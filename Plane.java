    ...
    public void act()
    {
        ...
        if (this.isTouching(Plane.class)) {
            for (Plane other : getIntersectingObjects(Plane.class)) {
                if (other != this && this.getName().startsWith("Plane") && other.getName().startsWith("Plane")) {
                    if (this.getName().equals("Plane1") && other.getName().equals("Plane2")) {
        ...
        if (this.getName().equals("Plane1") || this.getName().equals("Plane2")) {
            checkDistance(0);
        } else if (this.getName().equals("Plane3") || this.getName().equals("Plane4")) {
            checkDistance(100);
        }
    }
